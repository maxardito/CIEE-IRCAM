...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.5, 114.0, 79.0, 22.0 ],
					"text" : "prepend load"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 506.0, 262.0, 55.0, 22.0 ],
					"text" : "stripnote"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 625.0, 397.0, 167.0, 22.0 ],
					"text" : "adsr~ 5 50 0.6 500 @legato 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 834.0, 307.0, 39.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 32.25, 563.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 487.0, 191.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 157.0, 273.0, 167.0, 22.0 ],
					"text" : "adsr~ 5 50 0.6 500 @legato 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 357.0, 163.0, 39.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 23.0, 41.0, 22.0 ],
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 60.0, 336.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 221.0, 32.0, 22.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 40.0, 273.0, 66.0, 22.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 651.5, 44.0, 31.0, 22.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 716.0, 17.0, 137.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 566.5, 17.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 506.0, 132.0, 49.0, 22.0 ],
					"text" : "mode 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 493.0, 563.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 506.0, 487.0, 192.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 506.0, 440.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.384313725490196, 1.0, 0.788235294117647, 1.0 ],
					"id" : "obj-36",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 506.0, 316.0, 91.0, 22.0 ],
					"text" : "th.stof myScale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 506.0, 391.0, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.5, 82.0, 154.0, 22.0 ],
					"text" : "pipedum_22l.scl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 566.5, 142.0, 227.0, 22.0 ],
					"text" : "th.scala myScale @tune 440 @center 69"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 506.0, 174.0, 347.0, 52.0 ],
					"varname" : "jsui"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 576.0, 57.0, 576.0, 57.0 ],
					"order" : 0,
					"source" : [ "obj-92", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 576.0, 57.0, 515.5, 57.0 ],
					"order" : 1,
					"source" : [ "obj-92", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "th.scala.js",
				"bootpath" : "~/Documents/Max 8/Library/th.scala/code",
				"patcherrelativepath" : "../../../Max 8/Library/th.scala/code",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "th.scala.maxpat",
				"bootpath" : "~/Documents/Max 8/Library/th.scala/patchers",
				"patcherrelativepath" : "../../../Max 8/Library/th.scala/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
